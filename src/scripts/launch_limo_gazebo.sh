...
echo "    wsl -d Ubuntu-22.04 -- bash -c 'source /opt/ros/humble/setup.bash && source ~/thesis_ws/install/setup.bash && ros2 run teleop_twist_keyboard teleop_twist_keyboard'"
echo "============================================"
