...
\textbf{Total thesis period: 3 months — July 1 to October 1, 2026 (13 weeks).}
...
\noindent\textbf{Phase 1 — Consolidation (Weeks 1–2, Jul 1–14)}\\
...
\noindent\textbf{Phase 2 — Simulation Experiments (Weeks 2–6, Jul 8 – Aug 4)}\\
...
\noindent\textbf{Phase 3 — Simulation-to-Reality Transfer (Weeks 5–10, Jul 29 – Sep 8, contingent)}\\
...
\noindent\textbf{Phase 4 — Analysis (Weeks 9–11, Sep 1–22)}\\
...
\noindent\textbf{Phase 5 — Dedicated Writing \& Submission (Weeks 10–13, Sep 15 – Oct 1)}\\
...
\textbf{Registration date: July 1, 2026 \quad Target submission: October 1, 2026
(13 weeks)}
...
\begin{ganttchart}[
    ...
    % ── Column headers (week numbers / approximate months) ──────────────────
    \gantttitle{Jul}{4}
    \gantttitle{Aug}{4}
    \gantttitle{Sep}{4}
    \gantttitle{Oct}{1} \\
...
\midrule
M1 — Sim data collected   & Aug 4  & $N\geq 20$ simulation runs complete; CSV data logged. \\
M2 — Hardware trials done & Sep 8  & Real-robot stacking trials complete; comparison data logged. \\
